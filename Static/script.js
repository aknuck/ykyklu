\$( document ).ready(function() {
  ...
  for(n=0; n<(argsList["numberOfYaks"]-1); n++) {
    \$('#posts .row:last').after('<div class="row"><div class="col-2"><div class="time"></div><button class="comment-num"></button><div class="arrow-down"></div></div><div class="panel col-8"><div class="panel-heading"><h4 class="panel-title"></h4></div><div class="panel-body"></div></div><div class="votes"><a href="#" class="up-arrow">&#9650;</a><div class="yak-score"></div><a href="#" class="down-arrow">&#9660;</a></div></div>');
  }
